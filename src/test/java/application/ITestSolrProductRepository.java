...
import application.repository.SolrProductRepository;
import application.repository.SolrSearchableFields;
...
public class ITestSolrProductRepository extends AbstractSolrIntegrationTest {
	...
	public void testFacetQuery() {
		...
		FacetPage<Product> facetPage = repo.findByAvailableTrueAndNameStartingWith("pro");
